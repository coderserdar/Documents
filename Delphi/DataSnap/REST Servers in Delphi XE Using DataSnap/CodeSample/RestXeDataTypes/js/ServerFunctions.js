...
function TServerMethods1(connectionInfo)
{
  ...
  /*
   * @param a [in] - Type on server: Integer
   * @param b [in] - Type on server: Integer
   * @return result - Type on server: Integer
   */
  this.AddInt = function(a, b) {
    var returnObject = this.executor.executeMethod('AddInt', "GET", [a, b], arguments[2], true, arguments[3], arguments[4]);
    if (arguments[2] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.AddInt_URL = function(a, b) {
    return this.executor.getMethodURL("AddInt", "GET", [a, b], arguments[2])[0];
  };
   ...
   */
  this.AddDouble = function(a, b) {
    var returnObject = this.executor.executeMethod('AddDouble', "GET", [a, b], arguments[2], true, arguments[3], arguments[4]);
    if (arguments[2] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.AddDouble_URL = function(a, b) {
    return this.executor.getMethodURL("AddDouble", "GET", [a, b], arguments[2])[0];
  };
   ...
   */
  this.IsOK = function() {
    var returnObject = this.executor.executeMethod('IsOK', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.IsOK_URL = function() {
    return this.executor.getMethodURL("IsOK", "GET", [], arguments[0])[0];
  };

  /*
   * @param nCount [in] - Type on server: Integer
   * @return result - Type on server: string
   */
  this.GetLargeString = function(nCount) {
    var returnObject = this.executor.executeMethod('GetLargeString', "GET", [nCount], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.nCount = nCount;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.GetLargeString_URL = function(nCount) {
    return this.executor.getMethodURL("GetLargeString", "GET", [nCount], arguments[1])[0];
  };

  /*
   * @return result - Type on server: TPerson
   */
  ...
  /*
   * @return result - Type on server: TStringList
   */
  this.GetNames = function() {
    var returnObject = this.executor.executeMethod('GetNames', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetNames_URL = function() {
    return this.executor.getMethodURL("GetNames", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TPersonData
   */
  this.GetPersonWithData = function() {
    var returnObject = this.executor.executeMethod('GetPersonWithData', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetPersonWithData_URL = function() {
    return this.executor.getMethodURL("GetPersonWithData", "GET", [], arguments[0])[0];
  };
  ...
  this.GetCustomers = function() {
    var returnObject = this.executor.executeMethod('GetCustomers', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetCustomers_URL = function() {
    return this.executor.getMethodURL("GetCustomers", "GET", [], arguments[0])[0];
  };
  ...
  /*
   * @param strImageName [in] - Type on server: string
   * @param aStream [out] - Type on server: TStream
   * @return result - Type on server: Boolean
   */
  this.ImageAvailable = function(strImageName) {
    var returnObject = this.executor.executeMethod('ImageAvailable', "GET", [strImageName], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.strImageName = strImageName;
        resultObject.aStream = resultArray[0];
        resultObject.result = resultArray[1];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.ImageAvailable_URL = function(strImageName) {
    return this.executor.getMethodURL("ImageAvailable", "GET", [strImageName], arguments[1])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.GetPersonJson = function() {
    var returnObject = this.executor.executeMethod('GetPersonJson', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetPersonJson_URL = function() {
    return this.executor.getMethodURL("GetPersonJson", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONArray
   */
  this.GetNamesJson = function() {
    var returnObject = this.executor.executeMethod('GetNamesJson', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetNamesJson_URL = function() {
    return this.executor.getMethodURL("GetNamesJson", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["AddInt","AddDouble","IsOK","GetLargeString","GetPerson","GetNames","GetPersonWithData","GetCustomers","GetImage","ImageAvailable","GetPersonJson","GetNamesJson"]
};
