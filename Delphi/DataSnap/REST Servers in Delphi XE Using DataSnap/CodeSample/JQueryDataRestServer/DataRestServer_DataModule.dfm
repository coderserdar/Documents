object WebModule2: TWebModule2
  ...
  Actions = <
    ...
    item
      Name = 'WebActionItem1'
      PathInfo = '/client'
      Producer = ppJRestClient
    end
    item
      Name = 'WebActionItem2'
      PathInfo = '/datatables'
      Producer = ppDataTables
    end>
  ...
  object ppJRestClient: TPageProducer
    HTMLFile = 'templates\jRestClient.html'
    Left = 240
    Top = 120
  end
  object ppDataTables: TPageProducer
    HTMLFile = 'templates\datatable.html'
    Left = 312
    Top = 184
  end
end
