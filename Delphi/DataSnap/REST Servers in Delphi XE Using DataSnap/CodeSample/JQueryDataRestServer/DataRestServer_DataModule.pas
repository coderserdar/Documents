unit DataRestServer_DataModule;
...
type
  TWebModule2 = class(TWebModule)
    ...
    ppJRestClient: TPageProducer;
    ppDataTables: TPageProducer;
...
uses DataRestServer_ServerClass, WebReq;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := DataRestServer_ServerClass.TServerData.ClassName
