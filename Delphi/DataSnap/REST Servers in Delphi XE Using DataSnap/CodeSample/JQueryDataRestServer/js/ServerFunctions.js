...
function TServerData(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TServerData",connectionInfo);

  /*
   * @return result - Type on server: TJSONArray
   */
  this.Data = function() {
    var returnObject = this.executor.executeMethod('Data', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.Data_URL = function() {
    return this.executor.getMethodURL("Data", "GET", [], arguments[0])[0];
  };
   ...
   */
  this.Meta = function() {
    var returnObject = this.executor.executeMethod('Meta', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.Meta_URL = function() {
    return this.executor.getMethodURL("Meta", "GET", [], arguments[0])[0];
  };
  ...
  this.DataTables = function() {
    var returnObject = this.executor.executeMethod('DataTables', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.DataTables_URL = function() {
    return this.executor.getMethodURL("DataTables", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TDataSet
   */
  this.NativeTable = function() {
    var returnObject = this.executor.executeMethod('NativeTable', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.NativeTable_URL = function() {
    return this.executor.getMethodURL("NativeTable", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerData": ["Data","Meta","DataTables","NativeTable"]
};
