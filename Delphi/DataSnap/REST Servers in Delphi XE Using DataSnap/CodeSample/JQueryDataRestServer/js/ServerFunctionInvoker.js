...
function executeServerFunction(formId, className, methodName)
{
  ...
  for (var i = 0; i < formObj.elements.length; i++)
  {
    if (formObj.elements[i].type == 'text')
    {
      ...
      paramString += "'" + formObj.elements[i].value + "'";
    }
  }
  ...
  if (AdminInst != null)
  {
	...
	var connectionInfo = AdminInst.connectionInfo.toJSONString();
...
function updateResultFrame(className, methodName, resultObject)
{
  ...
  if (callCell != null && resultCell != null)
  {
    ...
    else
    {
      ...
      var resultString = resultObject == null ? "[no result]" : resultObject.toJSONString();
    }
